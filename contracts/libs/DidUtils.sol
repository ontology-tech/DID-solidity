...
library DidUtils {
    ...
    function verifyDIDFormat(string memory did) public pure returns (bool){
        ...
        bytes memory addressBytesData = BytesUtils.slice(didData, prefix.length, didData.length);
