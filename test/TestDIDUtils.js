...
contract('DidUtils', (accounts) => {
    it("verify did format", async () => {
        ...
        let r1 = await didUtils.verifyDIDFormat("did:trx:4c78c9baff8cf573f1e6dfc11bf3a027934aa8");
        let r2 = await didUtils.verifyDIDFormat("did:trx:4c78c9baff8cf573f1e6dfc11bf3a027934aa818");
        let r3 = await didUtils.verifyDIDFormat(":trx:0x4c78c9baff8cf573f1e6dfc11bf3a027934aa818");
